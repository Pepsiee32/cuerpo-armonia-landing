...
export default function Legales() {
  return (
    <div className="min-h-screen bg-off-white flex flex-col items-center justify-center px-4 py-20">
      <div className="max-w-2xl bg-white rounded-3xl shadow-lg p-8">
        <h1 className="text-3xl font-bold text-dark-sage mb-6">Aviso Legal y Políticas de Privacidad</h1>
        ...
        <h2 className="text-xl font-semibold text-dark-sage mt-6 mb-2">Propiedad Intelectual</h2>
        <p className="text-sage mb-4">
        ...
        <h2 className="text-xl font-semibold text-dark-sage mt-6 mb-2">Protección de Datos Personales</h2>
        <p className="text-sage mb-4">
        ...
        <h2 className="text-xl font-semibold text-dark-sage mt-6 mb-2">Uso de Cookies</h2>
        <p className="text-sage mb-4">
        ...
        <h2 className="text-xl font-semibold text-dark-sage mt-6 mb-2">Enlaces Externos</h2>
        <p className="text-sage mb-4">
        ...
        <h2 className="text-xl font-semibold text-dark-sage mt-6 mb-2">Modificaciones</h2>
        <p className="text-sage mb-4">
        ...
        <Link href="/" className="text-sage underline hover:text-dark-sage">Volver al inicio</Link>
      </div>
    </div>
  );
} 